...
const Index = () => {
  ...
  const screenshots = [
    { img: dashboardImg, title: "Dashboard Completo", desc: "Visualize tudo em tempo real com gráficos e métricas" },
        ...
        <div className="container mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fade-in">
              ...
              <h1 className="text-5xl lg:text-7xl font-black leading-tight animate-fade-in" style={{ animationDelay: '0.1s' }}>
                Transforme seu{" "}
              ...
              <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              {/* Stats */}
              <div className="grid grid-cols-3 gap-4 pt-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="relative animate-fade-in" style={{ animationDelay: '0.5s' }}>
              ...
              <img
                ...
                className="relative rounded-3xl shadow-[0_0_100px_hsl(280_90%_55%/0.4)] border-4 border-white hover:scale-105 transition-transform duration-500"
              />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  "Programa de fidelidade aumenta retorno em 40%",
                  ...
                  <div key={index} className="flex items-start gap-3 p-4 bg-primary/5 rounded-xl border border-primary/20 hover:scale-105 transition-transform duration-300">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              ...
              description="Gestão completa com visualização diária, semanal e mensal. Sistema evita conflitos automaticamente e permite reagendamentos fáceis com histórico completo."
            />
            <FeatureCard
              icon={Smartphone}
              title="Agendamento Online 24/7"
              description="Link compartilhável para clientes agendarem sozinhos, qualquer hora do dia. Reduz ligações em 70% e aumenta conversão de novos clientes."
            />
            <FeatureCard
              icon={Users}
              title="Gestão Completa de Clientes"
              description="Cadastro detalhado com histórico de todos os serviços, valores gastos, preferências e notas personalizadas por cliente."
            />
            <FeatureCard
              icon={DollarSign}
              title="Financeiro Profissional"
              description="Controle total de receitas, despesas, contas fixas e a receber. Gráficos visuais e relatórios detalhados para melhor gestão financeira."
            />
            <FeatureCard
              icon={Award}
              title="Programa de Fidelidade"
              description="Sistema de pontuação automático, classes de clientes VIP e recompensas personalizadas. Aumenta engajamento e retorno de clientes em até 40%."
            />
            <FeatureCard
              icon={Clock}
              title="Automações Inteligentes"
              description="Crie retornos recorrentes e agendamentos futuros automaticamente. Lembretes automáticos para que você nunca perca um cliente."
            />
            <FeatureCard
              icon={Scissors}
              title="Catálogo de Serviços"
              description="Gerencie todos os serviços com preços, duração estimada e análise detalhada dos serviços mais vendidos e lucrativos."
            />
            <FeatureCard
              icon={Settings}
              title="Configurações Avançadas"
              description="Defina horários de funcionamento personalizados, intervalos entre atendimentos e notificações customizadas para seu negócio."
            />
            <FeatureCard
              icon={BarChart3}
              title="Relatórios e Análises"
              description="Dashboards em tempo real, identificação de serviços mais lucrativos, previsão de recebimentos e métricas de desempenho completas."
            />
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="relative animate-fade-in">
              ...
              <button
                ...
                className="absolute left-4 top-1/2 -translate-y-1/2 bg-white hover:bg-primary hover:text-white text-primary p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-125"
                aria-label="Anterior"
              >
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 bg-white hover:bg-primary hover:text-white text-primary p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-125"
                aria-label="Próximo"
              >
                  ...
                  <button
                    ...
                    className={`rounded-full transition-all duration-300 ${
                      index === currentScreenshot
                        ? "bg-primary w-12 h-4"
                        : "bg-border hover:bg-primary/50 w-4 h-4"
                    }`}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            <TestimonialCard
              ...
              content="Meu faturamento aumentou 40% em 3 meses! O programa de fidelidade trouxe muitos clientes de volta. Melhor investimento que fiz no salão."
              rating={5}
            />
            <TestimonialCard
              name="João Santos"
              role="Barbearia Style - RJ"
              content="Economizo mais de 10 horas por semana que gastava organizando agenda manualmente. Agora os clientes agendam sozinhos e eu foco no atendimento."
              rating={5}
            />
            <TestimonialCard
              name="Ana Oliveira"
              role="Studio Ana Hair - MG"
              content="Sistema incrível! O controle financeiro me mostrou onde estava perdendo dinheiro. Consegui aumentar minha margem de lucro em 30%."
              rating={5}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                className="group text-center space-y-4 p-8 rounded-2xl bg-gradient-to-br from-white to-primary/5 border-2 border-border hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 hover:scale-105"
          ...
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible className="space-y-4">
              <FAQItem
                ...
                answer="Você paga apenas uma vez R$ 299,90 e tem acesso completo ao sistema para sempre. Sem mensalidades, sem taxas escondidas, sem surpresas. Todas as atualizações futuras estão incluídas gratuitamente."
              />
              <FAQItem
                value="item-2"
                question="O sistema funciona no celular?"
                answer="Sim! O sistema é 100% responsivo e funciona perfeitamente em computadores, tablets e celulares. Você pode até instalar como um aplicativo no seu celular para acesso ainda mais rápido e com função offline."
              />
              <FAQItem
                value="item-3"
                question="Preciso de conhecimentos técnicos para usar?"
                answer="Não! O sistema foi desenvolvido para ser extremamente intuitivo. Qualquer pessoa consegue usar sem dificuldades. Além disso, oferecemos suporte técnico completo para te ajudar em qualquer dúvida."
              />
              <FAQItem
                value="item-4"
                question="Posso usar em mais de um dispositivo?"
                answer="Sim! Você pode acessar o sistema de quantos dispositivos quiser - computador, tablet, celular. Todos os dados ficam sincronizados automaticamente em tempo real."
              />
              <FAQItem
                value="item-5"
                question="Meus dados ficam seguros?"
                answer="Absolutamente! Utilizamos as mesmas tecnologias de segurança dos maiores bancos do mundo. Seus dados ficam criptografados e protegidos, com backups automáticos diários."
              />
              <FAQItem
                value="item-6"
                question="E se eu não gostar do sistema?"
                answer="Sem problemas! Você tem 7 dias de garantia total. Se por qualquer motivo não ficar satisfeito, devolvemos 100% do seu investimento. Sem perguntas, sem burocracia."
              />
              <FAQItem
                value="item-7"
                question="Quantos clientes posso cadastrar?"
                answer="Quantos você quiser! Não há limite de clientes, agendamentos, serviços ou qualquer outra funcionalidade. Você tem acesso completo e ilimitado a todas as features."
              />
              <FAQItem
                value="item-8"
                question="Como funciona o suporte técnico?"
                answer="Oferecemos suporte técnico prioritário via WhatsApp e e-mail. Nossa equipe está sempre disponível para te ajudar com qualquer dúvida ou dificuldade que possa ter."
              />
            </Accordion>
          </div>
        </div>
        ...
        <div className="container mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center pt-6">
            <Button
              size="lg"
              variant="secondary"
              className="gap-2 text-xl h-16 px-10 font-bold hover:scale-105 transition-transform duration-300 shadow-2xl"
      ...
      <section id="contact" className="py-20 px-4 bg-foreground text-background">
        <div className="container mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-4">
            ...
            <Button
              size="lg"
              className="gap-2 text-lg h-14 px-8 bg-white hover:bg-white/90 text-foreground border-0 hover:scale-105 transition-transform duration-300"
